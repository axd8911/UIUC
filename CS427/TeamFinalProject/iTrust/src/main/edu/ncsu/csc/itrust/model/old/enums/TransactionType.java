...
public enum TransactionType {
	...
	/**EDIT_INITIAL_OBSTETRICS_RECORD**/
	EDIT_INITIAL_OBSTETRICS_RECORD(9302, "Edit Initial Obstetric Record", "Edit Initial Obstetric Record", true),
	/**CREATE_PRIOR_PREGNANCY_RECORD**/
	CREATE_PRIOR_PREGNANCY_RECORD(9303, "Create Prior Pregnancy Record", "Create Prior Pregnancy Record", true),
	/**VIEW_PRIOR_PREGNANCY_RECORD**/
	VIEW_PRIOR_PREGNANCY_RECORD(9304, "View Prior Pregnancy Record", "View Prior Pregnancy Record", true),
	/**EDIT_PRIOR_PREGNANCY_RECORD**/
	EDIT_PRIOR_PREGNANCY_RECORD(9305, "Edit Prior Pregnancy Record", "Edit Prior Pregnancy Record", true),
	/**ADD_ALLERGY**/
	...
	/**OBSTETRIC_OV_RECORD_ADD*/
	OBSTETRIC_OFFICEVISIT_CREATE(9400, "Add obstetric OV record", "Obstetric OV record Created", true),

	CREATE_CHILDBIRTH_VISIT(9600, "Create new childbirth visit", "Create new childbirth visit", true),

	/**OBSTETRIC_OV_RECORD_VIEW*/
	OBSTETRIC_OFFICEVISIT_VIEW(9401, "View obstetric OV record", "Viewed obstetric OV record", true),

	/**OBSTETRIC_OV_RECORD_EDIT*/
	OBSTETRIC_OFFICEVISIT_EDIT(9402, "Edit obstetric OV record", "Obstetric OV record edit success",true),

	/**ULTRASOUND_CREATE_ADD*/
	ULTRASOUND_CREATE_ADD(9403, "Add Ultrasound report", "Ultrasound report added", true),

	/**ULTRASOUND_CREATE_ADD*/
	OBSTETRIC_OFFICE_SCHEDULE_NEXT(9404, "Schedule next Obstetrics Office Visit", "Next obstetrics office visit has been scheduled", true),

	/**ULTRASOUND_CREATE_ADD*/
	OBSTETRIC_OFFICE_SCHEDULE_CHILDBIRTH(9405, "Schedule Childbirth visit", "Childbirth visit has" +
			" been scheduled", true),

	/**OBSTETRIC_OV_RECORD_VALIDATE*/
	OBSTETRIC_OFFICEVISIT_VALIDATE(9406, "Validate obstetric OV record", "Validated obstetric OV record", true),

	/**OBSTETRIC_OV_RECORD_VIEW_REMOVE*/
	OBSTETRIC_OFFICEVISIT_REMOVE(9407, "Remove obstetric OV record", "Removed obstetric OV record", true),

	/**OBSTETRIC_OV_RECORD_ADD_RH_SHOT*/
	OBSTETRIC_RHSHOT_CHECK(9408, "Check RHSHOT", "Validated for RH Shot", true),
	
	/**OBSTETRIC_RECORD_CREATE*/
	OBSTETRIC_RECORD_CREATE(9300, "Create obstetric record", "created obstetric record", true),
	
	/**OBSTETRIC_RECORD_VIEW*/
	OBSTETRIC_RECORD_VIEW(9301, "View obstetric record", "viewed obstetric record", true),
	
	/** CREATE_POSTNATAL_CARE_RECORD */
	CREATE_POSTNATAL_CARE_RECORD(82200, "create postnatal care record", "create postnatal care record", true),
	
	/** VIEW_POSTNATAL_CARE_RECORD*/
	VIEW_POSTNATAL_CARE_RECORD(82201, "View a postnatal care record", "View a postnatal care record", true),
	
	/** EDIT_POSTNATAL_CARE_RECORD*/
	EDIT_POSTNATAL_CARE_RECORD(82202, "Edit a postnatal care record", "Edit a postnatal care record", true),
	
	/**OBSTETRIC_CHILDBRITH_VISIT_CREATE*/
	OBSTETRIC_CHILDBRITH_VISIT_CREATE(9600, "Create childbirth visit", "created childbirth visit", true),
	
	/**OBSTETRIC_CHILDBRITH_DRUGS_ADD*/
	OBSTETRIC_CHILDBRITH_DRUGS_ADD(9601, "Add childbirth drugs", "Added childbirth drugs", true),
	
	/**OBSTETRIC_CHILDBRITH_BABY_BORN*/
	OBSTETRIC_CHILDBRITH_BABY_BORN(9602, "A baby is born", "A baby was born", true),
	
	/**OBSTETRIC_CHILDBRITH_BABY_CREATE*/
	OBSTETRIC_CHILDBRITH_BABY_CREATE(9603, "Create childbirth baby record", "Created childbirth baby record", true),
	
	/**OBSTETRIC_CHILDBRITH_VISIT_EDIT*/
	OBSTETRIC_CHILDBRITH_VISIT_EDIT(9604, "Edit childbirth visit", "Edited childbirth visit", true),
	
	/**OBSTETRIC_CHILDBRITH_VISIT_REMOVE*/
	OBSTETRIC_CHILDBRITH_VISIT_REMOVE(9605, "Remove childbirth visit", "Removed childbirth visit", true),
	
	/**OBSTETRIC_CHILDBRITH_VISIT_READ*/
	OBSTETRIC_CHILDBRITH_VISIT_READ(9606, "Read childbirth visit", "Read childbirth visit", true),

	/**OBSTETRIC_OV_RECORD ERROR RECORDED*/
	OBSTETRIC_OFFICEVISIT_ERROR(9409, "Error in obstetric office record process", "Error Occurred in " +
			"Obstetric office visit processing.",	true)
