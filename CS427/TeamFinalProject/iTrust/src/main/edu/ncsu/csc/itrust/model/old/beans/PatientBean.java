...
public class PatientBean implements Serializable, Comparable<PatientBean> {
	...
	private boolean obstetricEligible = false;
	...
	private Byte rhShotIndicator = 0;
	public boolean getObstetricEligible(){ return obstetricEligible;}

	public void setObstetricEligible(boolean b){ obstetricEligible = b;}
	...
	public Byte getRhShotIndicator() {
		return rhShotIndicator;
	}

	public void setRhShotIndicator(Byte rhShotIndicator) {
		this.rhShotIndicator = rhShotIndicator;
	}
