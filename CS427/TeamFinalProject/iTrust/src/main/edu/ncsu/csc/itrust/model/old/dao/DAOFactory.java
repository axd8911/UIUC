...
//	}
	...
	/**
	 * 
	 * @return this DAOFactory's ObstetRecDAO
	 */
	public ObstetRecDAO getObstetRecDAO() {
		return new ObstetRecDAO(this);
	}
	 ...
	 */
	public ObstetricOfficeVisitDAO getObstetricOfficeVisitDAO() {
		return new ObstetricOfficeVisitDAO(this);
	}
	
	/**
	 * 
	 * @return this DAOFactory's CHVApptDAO
	 */
	public CHVApptDAO getCHVApptDAO() {
		return new CHVApptDAO(this);
	}
	/**
	 *  
	 * @return this DAOFactory's PostnatalCareRecordDAO
	 */
	public PostnatalCareRecordDAO getPostnatalCareRecordDAO() {
        return new PostnatalCareRecordDAO(this);
    }
	 ...
	 * @return this DAOFactory's CHVApptDAO
	 */
	public CHVDeliveryDAO getCHVDeliveryDAO() {
		return new CHVDeliveryDAO(this);
	}
}
