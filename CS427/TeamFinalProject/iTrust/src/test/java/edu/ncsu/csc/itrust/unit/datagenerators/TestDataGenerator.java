...
public class TestDataGenerator {
	...
	public void dropAllTables() throws FileNotFoundException, IOException, SQLException{
		new DBBuilder(factory).executeSQLFile("sql/dropTables.sql");
	}

	public void createAllTables() throws FileNotFoundException, IOException, SQLException{
		new DBBuilder(factory).executeSQLFile("sql/createTables.sql");
	}
	...
	/**
	 * Generate dependency data for uc93 acceptance. Create two HCPs who are
	...
	/**
	 * Generate dependency data for uc93 acceptance. NOTE: also executes the
	...
	public void uc94Clean() throws SQLException,FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/uc94Clean.sql");
	}
	...
	public void uc94DataGen() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/uc94Junit5DataGen.sql");
	}

	public void uc94ClearTables() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/uc94Junit5ClearData.sql");
	}
	...
	/**
	 * Create necessary data for uc 822
	 * @throws SQLException
	 * @throws FileNotFoundException
	 * @throws IOException
	 */
	public void uc822() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/uc822.sql");
	}
}
