...
<%
	...
	if (formIsFilled) {
		...
		p.setObstetricEligible(request.getParameter("obstetricsEligibility").equals("Yes") ? true : false);
		try {
...
<table cellspacing=0 align=center cellpadding=0>
	<tr>
		...
		<table class="fTable" align=center style="width: 350px;">
			...
			<tr>
				<td class="subHeaderVertical">Obstetric Eligible:</td>
				<td><select name="obstetricsEligibility">
					<%

							String yesSelected = (p.getObstetricEligible()) ? "selected=selected" : "";
						    String noSelected = (!p.getObstetricEligible()) ? "selected=selected" : "";
					%>
					<option value="Yes" <%= StringEscapeUtils.escapeHtml("" + (yesSelected)) %>>Yes</option>
					<option value="No" <%= StringEscapeUtils.escapeHtml("" + (noSelected)) %>>No</option>
