...
CREATE TABLE ultrasound_records (
  ultrasound_record_id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  patient_mid BIGINT(20) UNSIGNED NOT NULL,
  create_date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  obstetric_office_visit_id BIGINT(20) UNSIGNED NOT NULL,
  image_location VARCHAR(255),
  crown_rump_length DOUBLE(10 , 2 ) NOT NULL DEFAULT 0.00,
  biparietal_diameter DOUBLE(10 , 2 ) NOT NULL DEFAULT 0.00,
  head_circumference DOUBLE(10 , 2 ) NOT NULL DEFAULT 0.00,
  femur_length DOUBLE(10 , 2 ) NOT NULL DEFAULT 0.00,
  occipitofrontal_diameter DOUBLE(10 , 2 ) NOT NULL DEFAULT 0.00,
  abdominal_circumference DOUBLE(10 , 2 ) NOT NULL DEFAULT 0.00,
  humerus_length DOUBLE(10 , 2 ) NOT NULL DEFAULT 0.00,
  estimated_fetal_weight DOUBLE(10 , 2 ) NOT NULL DEFAULT 0.00,
  PRIMARY KEY (ultrasound_record_id),
  FOREIGN KEY (patient_mid)
    REFERENCES patients (MID),
  FOREIGN KEY (obstetric_office_visit_id)
    REFERENCES obstetricOfficeVisit (OBVisitID)
)  ENGINE=MYISAM;

CREATE TABLE postnatal_care_record (
	postnatal_care_record_id		INT UNSIGNED AUTO_INCREMENT primary key,
	patient_mid 			BIGINT(20) UNSIGNED NOT NULL,
	...
	comment				varchar(100),
	release_date		DATE,
	FOREIGN KEY (patient_mid) REFERENCES patients(MID)
) ENGINE=MyISAM;

CREATE TABLE chvappointment (
	appt_id				INT UNSIGNED AUTO_INCREMENT primary key,
	doctor_id           BIGINT UNSIGNED NOT NULL,
	patient_id          BIGINT UNSIGNED NOT NULL,
	sched_date          DATETIME NOT NULL,
	appt_type           VARCHAR(30) NOT NULL,
	prefer_dmethod		VARCHAR(45) NOT NULL,
    when_scheduled		VARCHAR(30) NOT NULL,
	comment				TEXT
) ENGINE=MyISAM;

CREATE TABLE chvdelivery (
	delivery_id			BIGINT UNSIGNED AUTO_INCREMENT primary key,
	doctor_id           BIGINT UNSIGNED,
	patient_id          BIGINT UNSIGNED,
	delivery_date       DATETIME,
	delivery_method		VARCHAR(45),
	dosPitocin			INT UNSIGNED DEFAULT 0,
	dosNitrous			INT UNSIGNED DEFAULT 0,
	dosPethidine		INT UNSIGNED DEFAULT 0,
	dosEpidural			INT UNSIGNED DEFAULT 0,
	dosMagnesium		INT UNSIGNED DEFAULT 0,
	dosRHimmune			INT UNSIGNED DEFAULT 0
) ENGINE=MyISAM;

CREATE TABLE chvbaby (
	baby_id			BIGINT UNSIGNED AUTO_INCREMENT primary key,
	delivery_id     BIGINT UNSIGNED NOT NULL,
    mid		BIGINT UNSIGNED NOT NULL,
	first_name      VARCHAR(30),
	last_name       VARCHAR(30),
    gender          VARCHAR(10),
	FOREIGN KEY (delivery_id) REFERENCES chvdelivery(delivery_id)
) ENGINE=MyISAM;