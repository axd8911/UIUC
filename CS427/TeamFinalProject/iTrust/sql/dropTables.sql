...
DROP TABLE IF EXISTS obstetrec;
DROP TABLE IF EXISTS obstetpriorpreg;
DROP TABLE IF EXISTS postnatal_care_record;
DROP TABLE IF EXISTS obstetricofficevisit;
DROP TABLE IF EXISTS ultrasound_records;
DROP TABLE IF EXISTS chvappointment;
DROP TABLE IF EXISTS chvdelivery;
DROP TABLE IF EXISTS chvbaby;
